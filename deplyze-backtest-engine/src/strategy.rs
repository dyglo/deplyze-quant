...
pub fn signal_library() -> SignalLibrary {
    ...
    SignalLibrary {
        signals: vec![
            ...
            s(
                "carry_factor",
                SignalType::CarryFactor,
                "Carry Factor",
                "Rate-differential or curve-carry proxy normalized from available macro series.",
                UserTier::Pro,
                &["T10Y2Y", "DGS10", "DGS2"],
                "zscore",
            ),
            s(
                "trend_200d_slope",
                SignalType::TrendFactor,
                "Trend 200D Slope",
                "Causal normalized slope of the 200-day moving average of the traded instrument.",
                UserTier::Pro,
                &["asset_close"],
                "zscore",
            ),
            s(
                ...
                "Momentum scaled by realized volatility to favor stable trend over noisy trend.",
                UserTier::Pro,
                &["asset_close", "asset_return"],
                "zscore",
            ),
            s(
                "mean_reversion_z",
                ...
                "Mean Reversion (z)",
                "Inverted z-score of price versus a trailing rolling mean.",
                UserTier::Pro,
                &["asset_close"],
                "zscore",
            ),
            s(
                ...
                SignalType::YieldSpread,
                "Yield Curve Score",
                "Causal composite of Treasury curve level and direction.",
                UserTier::Pro,
                &["T10Y2Y", "DGS10", "DGS2"],
                "zscore",
            ),
            s(
                ...
                SignalType::CrossAssetMomentum,
                "Cross-Asset Momentum",
                "Relative momentum versus a broad risk benchmark when benchmark data is available.",
                UserTier::Pro,
                &["asset_close", "SPY"],
                "zscore",
            ),
