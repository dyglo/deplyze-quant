...
const KINDS: KindMeta[] = [
  // Market Analysis
  { id: 'daily-pulse',         label: 'Daily Market Pulse',        blurb: 'Top movers + headlines snapshot.',                    evidence: 'Twelve Data quotes + Serper headlines',       group: 'market' },
  { id: 'daily-macro',         label: 'Macro Context',             blurb: 'Fed Funds, CPI, 10Y, 2Y, U-3, GDP snapshot.',         evidence: 'Alpha Vantage macro series',                  group: 'market' },
  { id: 'instrument-snapshot', label: 'Instrument Snapshot',       blurb: 'Single instrument deep dive — quote, vol, catalysts.', evidence: 'Twelve Data + Finnhub profile/news',          group: 'market', needsSymbol: true },
  { id: 'cross-asset',         label: 'Cross-Asset Relationships', blurb: 'Pairwise correlations across a macro universe.',        evidence: 'Twelve Data OHLCV (60-day log-return ρ)',     group: 'market' },
  { id: 'sentiment',           label: 'Sentiment',                 blurb: 'Headline mood proxy across news sources.',             evidence: 'Tavily + Serper headlines',                   group: 'market' },
  { id: 'weekly-regime',       label: 'Weekly Regime Report',      blurb: 'Macro regime classification + asset allocation implication.', evidence: 'FRED macro + Twelve Data',             group: 'market' },
  { id: 'volatility',          label: 'Volatility Intelligence',   blurb: 'VIX, realised vol, term structure, risk events ahead.', evidence: 'Twelve Data OHLCV + headlines',             group: 'market' },
  { id: 'market-stress',       label: 'Market Stress Report',      blurb: 'Systemic stress indicators — spreads, vol, liquidity.', evidence: 'FRED + Twelve Data',                        group: 'market' },
  // Research & Strategy
  { id: 'earnings',            label: 'Earnings Intelligence',     blurb: 'Upcoming earnings + analyst consensus + beat/miss history.', evidence: 'Finnhub earnings + news',              group: 'strategy', needsSymbol: true },
  { id: 'sector-rotation',     label: 'Sector Rotation',           blurb: 'Relative performance + momentum across GICS sectors.',  evidence: 'Twelve Data ETF OHLCV',                    group: 'strategy' },
  { id: 'positioning',         label: 'Positioning Report',        blurb: 'COT-style positioning + speculative sentiment.',         evidence: 'Tavily research + headlines',               group: 'strategy' },
  { id: 'risk',                label: 'Risk Environment',          blurb: 'Tail risk, correlation breakdown, drawdown watch.',      evidence: 'Twelve Data + FRED spreads',               group: 'strategy' },
  { id: 'trade-thesis',        label: 'Trade Thesis',              blurb: 'Structured long/short thesis for a given instrument.',   evidence: 'Twelve Data + Finnhub + news',              group: 'strategy', needsSymbol: true },
  // Custom
  { id: 'custom',              label: 'Custom Research Brief',     blurb: 'Ask any research question — Gemini synthesises a response over live data.', evidence: 'All available providers', group: 'custom' },
];
  ...
  return (
    <div style={{ padding: '0 24px 32px', maxWidth: 1200, margin: '0 auto' }}>
      <PageHeader
        ...
        subtitle="13 briefing types synthesised by Gemini over live provider data. Persist to Firestore and remain accessible to the whole workspace."
      />
